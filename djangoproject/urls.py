...
urlpatterns = [
    ...
    path('recipes/login/', auth_views.LoginView.as_view(template_name='recipebook/login.html'), name='login'),
    path('recipes/logout/', auth_views.LogoutView.as_view(), name='logout'),
